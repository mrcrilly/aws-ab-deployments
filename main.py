...
def ensure_clean_cluster(asg_name, elb_name):
    if_verbose("Ensuring %s is a clean/healthy cluster" % asg_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--verbose", dest="verbose", help="Print messages about progress and what step we're at (default: false)", required=False, default=False)
